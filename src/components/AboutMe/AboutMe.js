    ...
    <section className="about-me" id="about-me">
      ...
      <div className="about-me__wrapper">
        ...
        <p className="about-me__text">
          Я родился и живу в Москве, закончил агрономический факультет РГАУ-МСХА им
          К.А.Тимирязева. У меня есть жена и две дочки. Мне нравится играть на
          фортепиано. Как-то увлекся и выучил известные композиции: Ennio
